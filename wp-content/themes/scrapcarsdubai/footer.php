		...
		<div class="footer-grid">
			...
			<div>
				...
				<ul class="footer-links">
					...
					<li><a href="<?php echo esc_url( scd_lang_url( '/faqs/' ) ); ?>"><?php scd_e( 'nav_faq' ); ?></a></li>
				</ul>
			</div>
			<div>
				<h4><?php scd_e( 'footer_services' ); ?></h4>
				<ul class="footer-links">
					<?php foreach ( array_slice( scd_services(), 0, 6 ) as $fsvc ) : ?>
					<li><a href="<?php echo esc_url( scd_service_url( $fsvc['slug'] ) ); ?>"><?php scd_e( $fsvc['title'] ); ?></a></li>
					<?php endforeach; ?>
				</ul>
			</div>
			<div>
				...
				<ul class="footer-links">
					...
					<?php foreach ( scd_address_lines() as $addr_line ) : ?>
					...
					<li>
						<a class="social-link" href="<?php echo esc_url( scd_instagram() ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( scd__( 'social_instagram' ) ); ?>">
							<svg class="social-logo instagram-logo" viewBox="0 0 24 24" width="20" height="20" aria-hidden="true">
								<defs>
							...
							<span><?php scd_e( 'social_instagram' ); ?></span>
						</a>
					</li>
					<?php endif; ?>
					<?php if ( scd_x() ) : ?>
...
<a class="float-wa" href="https://wa.me/<?php echo esc_attr( scd_whatsapp() ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( scd__( 'cta_whatsapp' ) ); ?>">
