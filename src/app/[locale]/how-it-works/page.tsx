...
export async function generateMetadata({
  ...
  const { title, description } = seoText(locale, "how_seo_title", "how_seo_desc");
  return buildPageMetadata({ locale, path: "/how-it-works", title, description });
}
    ...
    <main id="main">
      <JsonLd
        data={breadcrumbJsonLd(locale, [
          ...
          { name: t(locale, "nav_how"), path: "/how-it-works" },
        ])}
      />
